...
class Trainer:
    ...
    def get_train_dataloader(self, batch_size=8) -> DataLoader:
        """
    ...
    def compute_loss(self, model, inputs, flat_param=None, return_outputs=False):
        """
        ...
        if flat_param is not None:
            outputs = model(x=None, flat_param=flat_param, buffers=None, **inputs)
        else:
